            ...
            <div class="row">
              <div class="col-md-4 col-sm-2">
                <div class="language-wrapper">
                  <div class="box-language">
                    <form id="form-language">
                      <div class="btn-group toggle-wrap">
                        <span class="toggle">
                          <span>
                            <img src="assets/img/language/flag-lang.png" alt="English" title="English" height="11" width="16" />
                            English
                          </span>
                        ...
                        <ul style={{display: "none"}} class="toggle_cont pull-right">
                          ...
                          <li>
                            <button class="language-select" type="button" name="de-DE">
                              <img src="assets/img/language/de-DE.png"
                                alt="Deutsch" title="Deutsch" height="11" width="16" />Deutsch</button>
                          </li>
                          <li>
                  ...
                  <a><i class="icon-phone"></i> Call Us: (123) 456- 789</a>
                </div>
                <div class="clear"></div>
              </div>
